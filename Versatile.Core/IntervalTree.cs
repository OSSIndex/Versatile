...
namespace Versatile
{
    ...
    public struct Interval<T> where T : IComparable<T>
    {
            ...
            : this()
        {
            ...
            this.Start = start;
            this.IncludeStartPoint = this.IncludeEndPoint = false;
            this.End = end;
        }

        public Interval(T start, bool include_start, T end, bool include_end)
            : this()
        {
            if (start.CompareTo(end) >= 0)
            {
            ...
            this.Start = start;
            this.IncludeStartPoint = include_start;
            this.IncludeEndPoint = include_end;
            this.End = end;
        }
        ...
        public bool OverlapsWith(Interval<T> other)
        {
            ...
            else if ( other.IncludeEndPoint && this.IncludeStartPoint && this.Start.Equals(other.End))
            {
                return true;
            }
            else
        ...
        {
            return this.OverlapsWith(other) || other.OverlapsWith(this) ||
